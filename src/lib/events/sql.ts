/**
 * src/lib/events/sql.ts
 *
 * Scripts SQL de migration pour le module Événements.
 * Ces constantes sont consommées par :
 *   - src/app/admin/migration/_hooks/useMigration.ts
 *   - src/app/admin/migration/_sql.ts (si centralisation future)
 */
