...
export default function ProfilPage() {
  ...
  const handleDeleteAccount = async () => {
    ...
    if (!confirm('CONFIRMATION FINALE : toutes vos données seront supprimées. Continuer ?')) return;
    toast.success('Demande de suppression envoyée. L\'administrateur traitera votre demande.');
    // En production : envoyer une notification à l'admin pour traiter la suppression RGPD
  };
