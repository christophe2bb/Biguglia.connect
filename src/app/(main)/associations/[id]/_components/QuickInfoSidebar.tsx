...
import {
  Star, Shield, Bell, CheckCircle2, ChevronRight,
  Building2, Handshake, Calendar, MessageSquare,
} from 'lucide-react';
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-emerald-50 rounded-2xl border border-emerald-200 p-5 shadow-sm">
        ...
        <Link
          href={isLoggedIn ? '/notifications' : '/connexion'}
        ...
        >
          ...
          {isLoggedIn ? 'Gérer mes alertes' : 'Se connecter pour les alertes'}
        </Link>
      </div>
