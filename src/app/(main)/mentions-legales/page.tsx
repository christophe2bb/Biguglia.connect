  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="space-y-8 text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900 mb-3">6. Données personnelles</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900 mb-3">7. Droit applicable et juridiction</h2>
          <p>
