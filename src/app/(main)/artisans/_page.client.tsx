...
import { Search, MapPin, Shield, Clock, Star, ChevronRight } from 'lucide-react';
...
function ArtisansContent() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // Filtrer artisans vérifiés
      const enriched: EnrichedArtisan[] = (data || []).filter(a => {
