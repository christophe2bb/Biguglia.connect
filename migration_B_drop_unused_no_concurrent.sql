...
DROP INDEX IF EXISTS public.uq_trust_interaction;  -- trust_interactions (8192 bytes)
...
DROP INDEX IF EXISTS public.uq_review_per_interaction;  -- reviews (8192 bytes)
