...
--             (availability_window, pickup_notes, exchange_preferences,
--             condition_state) qui n'existaient pas encore dans le schéma DB,
--             provoquant l'erreur :
--             "Could not find the 'availability_window' column of 'listings'
--              in the schema cache"
-- ─────────────────────────────────────────────────────────────────────────────
